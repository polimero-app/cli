...
// Deps holds injectable dependencies for the temperature commands.
type Deps struct {
...
// Command returns the top-level "temperature" cobra command group.
...
// CommandWithDeps constructs the "temperature" cobra command group with injected dependencies.
